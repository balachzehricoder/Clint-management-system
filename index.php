...
<head>
  <meta charset="UTF-8">
  <title>wswebsolution clint management system</title>
...
<div class="wrapper">
 ...
 <div class="main-container">
  <div class="header">
   <div class="logo"><img src="https://wswebsolution.com/wp-content/uploads/2023/04/websolution-removebg-preview-1.png" height="100" alt=""></div>
  ...
  <div class="user-box second-box">
   <div class="cards-wrapper" style="--delay: 1s">
    ...
    <?php
    include 'config.php';
$sql = "SELECT id, first_name, last_name, email, mobile, contact_image, servises FROM customers";
               ...
               if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) { ?>
                      <tr>
                          ...
                          <td><img src="path/to/images/<?php echo $row['contact_image']; ?>" alt="Contact Image" style="width:50px; height:50px;"></td>
                          <td><?php echo $row['servises']; ?></td>
                      </tr>
                  <?php } 
              } else { ?>
